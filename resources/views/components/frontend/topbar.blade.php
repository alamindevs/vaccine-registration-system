    ...
    <nav class="topbar-main">
        ...
        <div class="topbar-left">
            <a href="../projects/projects-index.html" class="logo">
                <span><img src="{{ asset('contents/frontend') }}/assets/images/logo-sm.png" alt="logo-small" class="logo-sm" /> </span>
                <span><img src="{{ asset('contents/frontend') }}/assets/images/logo-dark.png" alt="logo-large" class="logo-lg" /></span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topbar-nav float-right mb-0">
            {{-- <li class="hidden-sm">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="javascript: void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                    English <img src="{{ asset('contents/frontend') }}/assets/images/flags/us_flag.jpg" class="ml-2" height="16" alt="" /> <i class="mdi mdi-chevron-down"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="javascript: void(0);"><span>German </span><img src="{{ asset('contents/frontend') }}/assets/images/flags/germany_flag.jpg" alt="" class="ml-2 float-right" height="14" /></a>
                    <a class="dropdown-item" href="javascript: void(0);"><span>Italian </span><img src="{{ asset('contents/frontend') }}/assets/images/flags/italy_flag.jpg" alt="" class="ml-2 float-right" height="14" /></a>
                    <a class="dropdown-item" href="javascript: void(0);"><span>French </span><img src="{{ asset('contents/frontend') }}/assets/images/flags/french_flag.jpg" alt="" class="ml-2 float-right" height="14" /></a>
                    <a class="dropdown-item" href="javascript: void(0);"><span>Spanish </span><img src="{{ asset('contents/frontend') }}/assets/images/flags/spain_flag.jpg" alt="" class="ml-2 float-right" height="14" /></a>
                    <a class="dropdown-item" href="javascript: void(0);"><span>Russian </span><img src="{{ asset('contents/frontend') }}/assets/images/flags/russia_flag.jpg" alt="" class="ml-2 float-right" height="14" /></a>
                </div>
            </li> --}}
            <!--end li-->
           ...
           {{--  <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user pr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('contents/frontend') }}/assets/images/users/user-4.jpg" alt="profile-user" class="rounded-circle" /> <span class="ml-1 nav-user-name hidden-sm">Dr.Amelia <i class="mdi mdi-chevron-down"></i></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                ...
                <ul class="navigation-menu">
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <!--end has-submenu-->
                            <li>
                                <a href="all-rooms.html"><i class="dripicons-home"></i>All Rooms</a>
                            </li>
                            <li>
                                <a href="expenses.html"><i class="dripicons-document"></i>Expenses Report</a>
                            </li>
                            <li>
                                <a href="departments.html"><i class="dripicons-view-thumb"></i>Departments</a>
                            </li>
                            <li>
                                <a href="insurance-company.html"><i class="dripicons-rocket"></i>Insurance Company</a>
                            </li>
                            <li>
                                <a href="events.html"><i class="dripicons-calendar"></i>Events</a>
                            </li>
                            <li>
                                <a href="chat.html"><i class="dripicons-conversation"></i>Chat</a>
                            </li>
                        </ul>
                        <!--end submenu-->
                    </li>
                   ...
                   {{--  <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <!--end has-submenu-->
                            <li>
                                <a href="leaves.html"><i class="dripicons-shopping-bag"></i>Leaves</a>
                            </li>
                            <li>
                                <a href="holidays.html"><i class="dripicons-headset"></i>Holidays</a>
                            </li>
                            <li>
                                <a href="attendance.html"><i class="dripicons-checkmark"></i>Attendance</a>
                            </li>
                        </ul>
                        <!--end submenu-->
                    </li> --}}
                   ...
                   {{--  <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="../pages/pages-profile.html"><i class="dripicons-user"></i>Profile</a>
                            </li>
                            <li>
                                <a href="../pages/pages-chat.html"><i class="dripicons-conversation"></i>Chat</a>
                            </li>
                            <li>
                                <a href="../pages/pages-contact-list.html"><i class="dripicons-user-id"></i>Contact List</a>
                            </li>
                            <li>
                                <a href="../pages/pages-tour.html"><i class="dripicons-rocket"></i>Tour</a>
                            </li>
                            <li>
                                <a href="../pages/pages-timeline.html"><i class="dripicons-clock"></i>Timeline</a>
                            </li>
                            <li>
                                <a href="../pages/pages-invoice.html"><i class="dripicons-document"></i>Invoice</a>
                            </li>
                            <li>
                                <a href="../pages/pages-treeview.html"><i class="dripicons-network-3"></i>Treeview</a>
                            </li>
                            <li>
                                <a href="../pages/pages-starter.html"><i class="dripicons-clipboard"></i>Starter</a>
                            </li>
                            <li>
                                <a href="../pages/pages-pricing.html"><i class="dripicons-article"></i>Pricing</a>
                            </li>
                            <li>
                                <a href="../pages/pages-blogs.html"><i class="dripicons-blog"></i>Blogs</a>
                            </li>
                            <li>
                                <a href="../pages/pages-faq.html"><i class="dripicons-question"></i>FAQ</a>
                            </li>
                            <li>
                  ...
                  {{--   <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="../authentication/auth-login.html"><i class="dripicons-enter"></i>Log In</a>
                            </li>
                            <li>
                                <a href="../authentication/auth-register.html"><i class="dripicons-pencil"></i>Register</a>
                            </li>
                            <li>
                                <a href="../authentication/auth-recover-pw.html"><i class="dripicons-clockwise"></i>Recover Password</a>
                            </li>
                            <li>
                                <a href="../authentication/auth-lock-screen.html"><i class="dripicons-lock"></i>Lock Screen</a>
                            </li>
                            <li>
                                <a href="../authentication/auth-404.html"><i class="dripicons-warning"></i>Error 404</a>
                            </li>
                            <li>
